...
<footer role="contentinfo">
    <address class="vcard h-card not-yet-ready">
      <a href="<?php echo esc_url( home_url('/') ); ?>" itemprop="url" class="u-url url uid"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/depone.jpg" class="u-photo avatar--header" alt="Portrait von Daniel Ehniss"><span class="visually-hidden"><?php bloginfo('name'); ?></span></a>
      ...
      <p>Neben diesem Blog findest Du mich auch auf <a href="https://twitter.com/depone" class="u-url" rel="me">Twitter</a> und <a href="https://mastodon.social/@depone" rel="me">Mastodon</a>.</p>
    </address>
